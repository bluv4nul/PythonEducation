...
В ходе выполнения столкнулся с проблемой реализации подписки пользователей на валюты. Так же была проблема понимания работы сервера, но благодаря документации и примерам удалось разобраться в этом вопросе. В целом, работа позволила освоить базовые механизмы создания клиент-серверных приложений на Python, а также научиться работать с шаблонизатором Jinja2 и реализовывать модели предметной области с соблюдением стандартов оформления кода.

Было освоено получение данных из внешнего источника и их обработка, что является важным навыком при разработке веб-приложений. 

По моему мнению успешно удалось применить принципы MVC и реализовать функциональное веб-приложение с использованием стандартных библиотек Python.
